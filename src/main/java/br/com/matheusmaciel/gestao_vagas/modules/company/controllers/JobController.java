...
import br.com.matheusmaciel.gestao_vagas.modules.company.useCases.CreateJobUseCase;
import br.com.matheusmaciel.gestao_vagas.modules.company.useCases.ListAllJobsByCompanyUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Listagem de vagas", description = "Essa função é responsável por listar as vagas dentro da empresa")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
                    @Content(schema = @Schema(implementation = JobEntity.class))
            })
